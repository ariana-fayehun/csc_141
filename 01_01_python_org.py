...
The language reference can be referenced for a complete explanation of Python's syntax and the ActiveState
Python Cookbook can show common recipes and patterns that programmers often use when they code.
