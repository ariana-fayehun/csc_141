# I rate this assignment a 2 because I had a little trouble, but I figured it out.
...
try:
    ...
    print(f"File path {path1} is not found.")
...
try:
    ...
    print(f"File path {path2} is not found.")
